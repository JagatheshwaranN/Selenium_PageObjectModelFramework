...
public class PFReportListener extends PageFactoryPage implements ITestListener, ISuiteListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		String passTestCaseBase64Snapshot = ((TakesScreenshot) PageFactoryPage.driver)
	...
	public void onTestFailure(ITestResult result) {
		...
		System.setProperty("org.uncommons.reportng.escape-output", "false");
		TestUtil.waitForSomeTime();
		String failTestCaseBase64Snapshot = ((TakesScreenshot) PageFactoryPage.driver)
				.getScreenshotAs(OutputType.BASE64);
